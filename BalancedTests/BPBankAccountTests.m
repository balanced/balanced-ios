...
- (void)testValidAccountTypeSavingsUppercase {
    BPBankAccount *ba = [[BPBankAccount alloc] initWithRoutingNumber:@"053101273" accountNumber:@"111111111111" accountType:BPBankAccountTypeSavings name:@"Johann Bernoulli"];
    STAssertTrue(ba.accountTypeValid, @"Should be a valid account type");
}
...
- (void)testInvalidAccountType {
    BPBankAccount *ba = [[BPBankAccount alloc] initWithRoutingNumber:@"053101273" accountNumber:@"111111111111" accountType:BPBankAccountTypeUnknown name:@"Johann Bernoulli"];
    STAssertFalse(ba.accountTypeValid, @"Should not be a valid account type");
}

- (void)testAccountTypeChecking {
    BPBankAccountType accountType = BPBankAccountTypeChecking;
    ...
    STAssertTrue(ba.accountType==accountType, @"Account type should be %@", accountType);
}

- (void)testAccountTypeSavings {
    BPBankAccountType accountType = BPBankAccountTypeSavings;
    BPBankAccount *ba = [[BPBankAccount alloc] initWithRoutingNumber:@"053101273" accountNumber:@"111111111111" accountType:accountType name:@"Johann Bernoulli"];
    STAssertTrue(ba.accountType==BPBankAccountTypeSavings, @"Account type should be %@", accountType);
}
...
- (void)testValidWithInvalidRoutingNumber {
    BPBankAccount *ba = [[BPBankAccount alloc] initWithRoutingNumber:@"810770808790897089" accountNumber:@"111111111111" accountType:BPBankAccountTypeSavings name:@"Johann Bernoulli"];
...
- (void)testValidWithEverthingInvalid {
    BPBankAccount *ba = [[BPBankAccount alloc] initWithRoutingNumber:@"810770808790897089" accountNumber:@"111111111111" accountType:BPBankAccountTypeUnknown name:@""];
    STAssertFalse(ba.valid, @"Bank account should not be valid");
...
- (void)testAccountOptionalFields {
    ...
    BPBankAccount *ba = [[BPBankAccount alloc] initWithRoutingNumber:@"053101273" accountNumber:@"111111111111" accountType:BPBankAccountTypeSavings name:@"Johann Bernoulli" optionalFields:optionalFields];
